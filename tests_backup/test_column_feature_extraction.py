"""
Tests for the column-based feature extraction module.

This module contains tests for the ColumnFeatureExtractor, ColumnPCAFeatureExtractor,
and TemporalColumnFeatureExtractor classes.
"""
...
class TestColumnFeatureExtractor:
    ...
    def test_detect_column_types(self, sample_data):
    ...
    def test_transform_numeric(self, sample_data):
    ...
    def test_transform_datetime(self, sample_data):
    ...
    def test_transform_text(self, sample_data):
...
class TestColumnPCAFeatureExtractor:
    ...
    def test_pca_all_columns(self, sample_data):
...
class TestTemporalColumnFeatureExtractor:
    ...
    def test_transform(self, sample_time_series):
