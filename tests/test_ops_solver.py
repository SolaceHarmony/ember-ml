...
This module tests the solver operations across different backends.
"""
...
class TestSolverOps:
    ...
    def test_solve(self):
        ...
        a = ops.convert_to_tensor([[3, 1], [1, 2]], dtype='float32')
        b = ops.convert_to_tensor([9, 8], dtype='float32')
    ...
    def test_qr(self):
        """Test qr operation."""
        # Create a simple matrix
        a = ops.convert_to_tensor([[3, 1], [1, 2], [0, 1]], dtype='float32')
        ...
        try:
            ...
            q_transpose = ops.transpose(q_mlx)
            q_transpose_q = ops.matmul(q_transpose, q_mlx)
            identity = ops.eye(q_transpose_q.shape[0])
        ...
        try:
            ...
            # Check that Q is orthogonal (Q^T @ Q = I)
            q_transpose = ops.transpose(q_torch)
    ...
    def test_cholesky(self):
        ...
        a = ops.convert_to_tensor([[4, 1], [1, 3]], dtype='float32')
        ...
        try:
            ...
            # Check that L @ L.T = A
            l_transpose = ops.transpose(l_mlx)
        ...
        try:
            ...
            # Check that L @ L.T = A
            l_transpose = ops.transpose(l_torch)
    ...
    def test_lstsq(self):
        ...
        a = ops.convert_to_tensor([[3, 1], [1, 2], [0, 1]], dtype='float32')
        b = ops.convert_to_tensor([9, 8, 3], dtype='float32')
