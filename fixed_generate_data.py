"""
Fixed version of the generate_data function from the advanced_anomaly_detection.ipynb notebook.
This version replaces tensor.index_update calls with bracket assignment syntax.
"""
...
def generate_data(n_samples=1000, n_features=10, anomaly_fraction=0.05):
    ...
    for i in range(1, n_features):
        ...
        # Update the tensor using bracket assignment, which delegates to slice_update
