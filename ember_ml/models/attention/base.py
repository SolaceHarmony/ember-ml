...
class AttentionMask:
    ...
    @staticmethod
    def create_padding_mask(lengths: tensor, max_len: int) -> TensorLike:
        """
    ...
    @staticmethod
    def create_causal_mask(seq_len: int) -> TensorLike:
        """
    ...
    @staticmethod
    def create_window_mask(seq_len: int, window_size: int) -> TensorLike:
        """
...
class AttentionScore:
    ...
    @staticmethod
    def dot_product(query: tensor, key: TensorLike) -> TensorLike:
        """
    ...
    def additive(query: tensor,
                 key: tensor,
                 weight: tensor,
                 bias: Optional[TensorLike] = None) -> TensorLike:
        """
