...
class LiquidForecaster(Module):
    ...
    def evaluate(self, x, y, time_delta=None):
        ...
        # Compute metrics
        mse = stats.mean(ops.square(ops.subtract(first_step_pred, y)))
        mae = stats.mean(ops.abs(ops.subtract(first_step_pred, y)))
        ...
        calibration = stats.mean(tensor.cast(in_bounds, tensor.float32))
