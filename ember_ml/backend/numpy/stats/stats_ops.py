...
class NumpyStatsOps:
    ...
    def gaussian(self, input_value: TensorLike, mu: TensorLike = 0.0, sigma: TensorLike = 1.0) -> np.ndarray:
        """
        ...
        """
        from ember_ml.backend.numpy.stats.ops.descriptive import gaussian as gaussian_func
