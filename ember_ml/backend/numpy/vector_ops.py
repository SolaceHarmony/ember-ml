...
class NumpyVectorOps: # Class methods just call module-level functions now
    """NumPy implementation of vector operations."""

    def fft(self, input_array: TensorLike, output_length: Optional[int] = None, axis: int = -1) -> np.ndarray:
        """Compute the one-dimensional discrete Fourier Transform."""
        return fft(input_array, output_length, axis)

    def ifft(self, input_array: TensorLike, output_length: Optional[int] = None, axis: int = -1) -> np.ndarray:
        """Compute the one-dimensional inverse discrete Fourier Transform."""
        return ifft(input_array, output_length, axis)

    def fft2(self, input_array: TensorLike, output_shape: Optional[Shape] = None, axes: Axis = (-2, -1)) -> np.ndarray:
        """Compute the two-dimensional discrete Fourier Transform."""
        return fft2(input_array, output_shape, axes)

    def ifft2(self, input_array: TensorLike, output_shape: Optional[Shape] = None, axes: Axis = (-2, -1)) -> np.ndarray:
        """Compute the two-dimensional inverse discrete Fourier Transform."""
        return ifft2(input_array, output_shape, axes)

    def fftn(self, input_array: TensorLike, output_shape: Optional[Shape] = None, axes: Axis = None) -> np.ndarray:
        """Compute the N-dimensional discrete Fourier Transform."""
        return fftn(input_array, output_shape, axes)

    def ifftn(self, input_array: TensorLike, output_shape: Optional[Shape] = None, axes: Axis = None) -> np.ndarray:
        """Compute the N-dimensional inverse discrete Fourier Transform."""
        return ifftn(input_array, output_shape, axes)

    def rfft(self, input_array: TensorLike, output_length: Optional[int] = None, axis: int = -1) -> np.ndarray:
        """Compute the one-dimensional discrete Fourier Transform for real input."""
        return rfft(input_array, output_length, axis)

    def irfft(self, input_array: TensorLike, output_length: Optional[int] = None, axis: int = -1) -> np.ndarray:
        """Compute the one-dimensional inverse discrete Fourier Transform for real input."""
        return irfft(input_array, output_length, axis)

    def rfft2(self, input_array: TensorLike, output_shape: Optional[Shape] = None, axes: Axis = (-2, -1)) -> np.ndarray:
        """Compute the two-dimensional discrete Fourier Transform for real input."""
        return rfft2(input_array, output_shape, axes)

    def irfft2(self, input_array: TensorLike, output_shape: Optional[Shape] = None, axes: Axis = (-2, -1)) -> np.ndarray:
        """Compute the two-dimensional inverse discrete Fourier Transform for real input."""
        return irfft2(input_array, output_shape, axes)

    def rfftn(self, input_array: TensorLike, output_shape: Optional[Shape] = None, axes: Axis = None) -> np.ndarray:
        """Compute the N-dimensional discrete Fourier Transform for real input."""
        return rfftn(input_array, output_shape, axes)

    def irfftn(self, input_array: TensorLike, output_shape: Optional[Shape] = None, axes: Axis = None) -> np.ndarray:
        """Compute the N-dimensional inverse discrete Fourier Transform for real input."""
        return irfftn(input_array, output_shape, axes)

    def normalize_vector(self, input_vector: TensorLike) -> np.ndarray:
        """
        Normalize an input vector to unit length (L2 norm).
    ...
    def compute_energy_stability(self, input_wave: TensorLike, window_size: int = 100) -> np.ndarray:
        """
        Compute the energy stability of a wave signal.
    ...
    def compute_interference_strength(self, input_wave1: TensorLike, input_wave2: TensorLike) -> np.ndarray:
        """
        Compute the interference strength between two wave signals.
    ...
    def compute_phase_coherence(self, input_wave1: TensorLike, input_wave2: TensorLike, freq_range: Optional[Tuple[float, float]] = None) -> np.ndarray:
        """
        Compute the phase coherence between two wave signals.
    ...
    def partial_interference(self, input_wave1: TensorLike, input_wave2: TensorLike, window_size: int = 100) -> np.ndarray:
        """
        Compute the partial interference between two wave signals over sliding windows.
    ...
    def euclidean_distance(self, vector1: TensorLike, vector2: TensorLike) -> np.ndarray:
        """
        Compute the Euclidean (L2) distance between two vectors.
    ...
    def cosine_similarity(self, vector1: TensorLike, vector2: TensorLike) -> np.ndarray:
        """
        Compute the cosine similarity between two vectors.
    ...
    def exponential_decay(self, initial_value: TensorLike, decay_rate: TensorLike, time_step: Optional[TensorLike] = None) -> np.ndarray:
        """
