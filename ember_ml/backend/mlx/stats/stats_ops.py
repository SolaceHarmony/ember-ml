"""
MLX implementation of statistical operations.

This module provides MLX implementations of the statistical operations interface.
"""
...
class MLXStatsOps:
    ...
    def median(self, x: TensorLike, axis: Optional[Union[int, Sequence[int]]] = None, 
        ...
        """
        from ember_ml.backend.mlx.stats.ops import median as median_func
    ...
    def std(self, x: TensorLike, axis: Optional[Union[int, Sequence[int]]] = None, 
        ...
        """
        from ember_ml.backend.mlx.stats.ops import std as std_func
        return std_func(x, axis=axis, keepdims=keepdims, ddof=ddof)
    
    def percentile(self, x: TensorLike, q: Union[float, Any], 
        ...
        """
        from ember_ml.backend.mlx.stats.ops import percentile as percentile_func
    ...
    def mean(self, x: TensorLike, axis: Optional[Union[int, Sequence[int]]] = None,
        ...
        Returns:
            Mean of the tensor
        """
        from ember_ml.backend.mlx.stats.ops import mean as mean_func
    ...
    def var(self, x: TensorLike, axis: Optional[Union[int, Sequence[int]]] = None,
        ...
        """
        from ember_ml.backend.mlx.stats.ops import var as var_func
    ...
    def max(self, x: TensorLike, axis: Optional[Union[int, Sequence[int]]] = None,
        ...
        """
        from ember_ml.backend.mlx.stats.ops import max as max_func
    ...
    def min(self, x: TensorLike, axis: Optional[Union[int, Sequence[int]]] = None,
        ...
        """
        from ember_ml.backend.mlx.stats.ops import min as min_func
    ...
    def sum(self, x: TensorLike, axis: Optional[Union[int, Sequence[int]]] = None,
        ...
        Returns:
            Sum of the tensor
        """
        from ember_ml.backend.mlx.stats.ops import sum as sum_func
        return sum_func(x, axis=axis, keepdims=keepdims)
    
    def cumsum(self, x: TensorLike, axis: Optional[int] = None) -> mx.array:
        """
        ...
        """
        from ember_ml.backend.mlx.stats.ops import cumsum as cumsum_func
    ...
    def argmax(self, x: TensorLike, axis: Optional[int] = None,
        ...
        """
        from ember_ml.backend.mlx.stats.ops import argmax as argmax_func
        return argmax_func(x, axis=axis, keepdims=keepdims)
    
    def sort(self, x: TensorLike, axis: int = -1, descending: bool = False) -> mx.array:
        """
        ...
        Returns:
            Sorted tensor
        """
        from ember_ml.backend.mlx.stats.ops import sort as sort_func
        return sort_func(x, axis=axis, descending=descending)
    
    def argsort(self, x: TensorLike, axis: int = -1, descending: bool = False) -> mx.array:
        """
