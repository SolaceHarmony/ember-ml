...
import neural_lib.backend.torch_backend as torch_backend_original

# Import the optimized PyTorch backend
import neural_lib.backend.torch_backend_optimized as torch_backend_optimized

def benchmark_operation(operation_name, sizes=[1000, 2000, 4000], repeats=5):
